...
parser.add_argument('--input_LR_path', type=str, default='D:\project\VDSR-self\data\Set5\LR/', help='input path to use')
parser.add_argument('--input_HR_path', type=str, default='D:\project\VDSR-self\data\Set5\HR/', help='input path to use')
parser.add_argument('--model', type=str, default='D:\project\VDSR-self\checkpoint\model_epoch_50.pth', help='model file to use')
parser.add_argument('--output_path', default='D:/project/VDSR-self/outputs/', type=str, help='where to save the output image')
